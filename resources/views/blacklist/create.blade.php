                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-8 col-md-9">
                          <div class="form-group{{ $errors->has('accomplice') ? ' has-danger' : '' }}">
                            <input class="form-control{{ $errors->has('accomplice') ? ' is-invalid' : '' }}" name="accomplice" id="input-accomplice" type="text" placeholder="{{ __('Accomplice') }}" value="{{ old('accomplice') }}" />
