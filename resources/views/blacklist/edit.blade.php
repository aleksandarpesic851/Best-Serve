              ...
              <div class="card-body ">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    ...
                    <div class="row">
                      <label class="col-sm-3 col-form-label" for="input-business">{{ __(' Business') }}</label>
                      <div class="col-sm-7">
                    ...
                    <div class="row">
                      <label class="col-sm-3 col-form-label" for="input-birthday">{{ __('Birthday') }}</label>
                      <div class="col-sm-7">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-9">
                          <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                            <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" value="{{ old('email', $blacklist->email) }}" name="email" id="input-email" type="email" placeholder="{{ __('Email') }}" value="{{ old('email') }}" required />
                            @if ($errors->has('email'))
