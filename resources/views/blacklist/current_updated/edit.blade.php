                        ...
                        <div class="row d-flex justify-content-center">
                          <div class="col-10">
                            <div class="form-group{{ $errors->has('type_id') ? ' has-danger' : '' }}">
                              <input class="form-control{{ $errors->has('type_id') ? ' is-invalid' : '' }}" value="{{ old('type_id', $blacklist->type_id) }}" name="national_id_card_no" id="input-type_id" type="text" placeholder="{{ __('messages.type_identification') }}" value="{{ old('type_id') }}" />
