                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-8 col-md-9">
                        <div class="form-group{{ $errors->has('full_name') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('full_name') ? ' is-invalid' : '' }}" value="{{ old('full_name', $blacklist->full_name) }}" name="full_name" id="input-full_name" type="text"  value="{{ old('full_name') }}" required="true" aria-required="true"/>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-8 col-md-9">
                        <div class="form-group">
                          <input class="form-control" data-toggle="datepicker" name="birthday" id="input-birthday" value="{{ old('birthday', $blacklist->birthday) }}" type="text" value="" required />
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-8 col-md-9">
                        <div class="form-group{{ $errors->has('national_id_card_no') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('national_id_card_no') ? ' is-invalid' : '' }}" value="{{ old('national_id_card_no', $blacklist->national_id_card_no) }}" name="national_id_card_no" id="input-national_id_card_no" type="text"  value="{{ old('national_id_card_no') }}" />
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-8 col-md-9">
                        <div class="form-group{{ $errors->has('country_residence') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('country_residence') ? ' is-invalid' : '' }}" value="{{ old('country_residence', $blacklist->country_residence) }}" name="country_residence" id="input-country_residence" type="text" value="{{ old('country_residence') }}" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 col-md-9">
                          <div class="form-group{{ $errors->has('zip_code') ? ' has-danger' : '' }}">
                            <input class="form-control{{ $errors->has('zip_code') ? ' is-invalid' : '' }}" value="{{ old('zip_code', $blacklist->zip_code) }}" name="zip_code" id="input-zip_code" type="text" value="{{ old('zip_code') }}" />
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-8 col-md-9">
                          <div class="form-group{{ $errors->has('firstname') ? ' has-danger' : '' }}">
                            <input class="form-control{{ $errors->has('firstname') ? ' is-invalid' : '' }}" value="{{ old('firstname', $blacklist->firstname) }}" name="firstname" id="input-firstname" type="text" value="{{ old('firstname') }}" />
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-8 col-md-9">
                          <div class="form-group{{ $errors->has('maidenname') ? ' has-danger' : '' }}">
                            <input class="form-control{{ $errors->has('maidenname') ? ' is-invalid' : '' }}" value="{{ old('maidenname', $blacklist->maidenname) }}" name="maidenname" id="input-maidenname" type="text" value="{{ old('maidenname') }}" />
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-8 col-md-9">
                          <div class="form-group{{ $errors->has('country_birth') ? ' has-danger' : '' }}">
                            <input class="form-control{{ $errors->has('country_birth') ? ' is-invalid' : '' }}" value="{{ old('country_birth', $blacklist->country_birth) }}" name="country_birth" id="input-country_birth" type="text" value="{{ old('country_birth') }}" />
                       ...
                       <div class="row">
                        ...
                        <div class="col-sm-8 col-md-9">
                          <div class="form-group{{ $errors->has('color_eye') ? ' has-danger' : '' }}">
                            <input class="form-control{{ $errors->has('color_eye') ? ' is-invalid' : '' }}" value="{{ old('color_eye', $blacklist->color_eye) }}" name="color_eye" id="input-color_eye" type="text" value="{{ old('color_eye') }}" />
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-8 col-md-9">
                          <div class="form-group{{ $errors->has('visible_peculiarity') ? ' has-danger' : '' }}">
                            <input class="form-control{{ $errors->has('visible_peculiarity') ? ' is-invalid' : '' }}" value="{{ old('visible_peculiarity', $blacklist->visible_peculiarity) }}" name="visible_peculiarity" id="input-visible_peculiarity" type="text" value="{{ old('visible_peculiarity') }}" />
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-8 col-md-9">
                          <div class="form-group{{ $errors->has('profession') ? ' has-danger' : '' }}">
                            <input class="form-control{{ $errors->has('profession') ? ' is-invalid' : '' }}" value="{{ old('profession', $blacklist->profession) }}" name="profession" id="input-profession" type="text"  value="{{ old('profession') }}" />
                       ...
                       <div class="row">
                        ...
                        <div class="col-sm-8 col-md-9">
                          <div class="form-group{{ $errors->has('surburb') ? ' has-danger' : '' }}">
                            <input class="form-control{{ $errors->has('surburb') ? ' is-invalid' : '' }}" value="{{ old('surburb', $blacklist->surburb) }}" name="surburb" id="input-surburb" type="text"  value="{{ old('surburb') }}" />
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-8 col-md-9">
                          <div class="form-group{{ $errors->has('telephone_no') ? ' has-danger' : '' }}">
                            <input class="form-control{{ $errors->has('telephone_no') ? ' is-invalid' : '' }}" value="{{ old('telephone_no', $blacklist->telephone_no) }}" name="telephone_no" id="input-telephone_no" type="text" value="{{ old('telephone_no') }}" />
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-8 col-md-9">
                        <div class="form-group{{ $errors->has('business') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('business') ? ' is-invalid' : '' }}" value="{{ old('business', $blacklist->business) }}"  type="text" name="business" id="input-business" value="" required />
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-8 col-md-9">
                        <div class="form-group{{ $errors->has('nationality') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('nationality') ? ' is-invalid' : '' }}" value="{{ old('nationality', $blacklist->nationality) }}" name="nationality" id="input-nationality" type="text"  value="{{ old('nationality') }}" required />
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-8 col-md-9">
                        <div class="form-group{{ $errors->has('social_security_no') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('social_security_no') ? ' is-invalid' : '' }}" value="{{ old('social_security_no', $blacklist->social_security_no) }}" name="social_security_no" id="input-social_security_no" type="text" value="{{ old('social_security_no') }}" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 col-md-9">
                          <div class="form-group{{ $errors->has('surname') ? ' has-danger' : '' }}">
                            <input class="form-control{{ $errors->has('surname') ? ' is-invalid' : '' }}" value="{{ old('surname', $blacklist->surname) }}" name="surname" id="input-surname" type="text" value="{{ old('surname') }}" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 col-md-9">
                          <div class="form-group{{ $errors->has('othername') ? ' has-danger' : '' }}">
                            <input class="form-control{{ $errors->has('othername') ? ' is-invalid' : '' }}" value="{{ old('othername', $blacklist->othername) }}" name="othername" id="input-othername" type="text" value="{{ old('messages.other_name') }}" />
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-8 col-md-9">
                          <div class="form-group{{ $errors->has('city_birth') ? ' has-danger' : '' }}">
                            <input class="form-control{{ $errors->has('city_birth') ? ' is-invalid' : '' }}" value="{{ old('city_birth', $blacklist->city_birth) }}" name="city_birth" id="input-city_birth" type="text"  value="{{ old('city_birth') }}" />
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-8 col-md-9">
                          <div class="form-group{{ $errors->has('height') ? ' has-danger' : '' }}">
                            <input class="form-control{{ $errors->has('height') ? ' is-invalid' : '' }}" value="{{ old('height', $blacklist->height) }}" name="height" id="input-height" type="text"  value="{{ old('height') }}" />
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-8 col-md-9">
                          <div class="form-group{{ $errors->has('color_hair') ? ' has-danger' : '' }}">
                            <input class="form-control{{ $errors->has('color_hair') ? ' is-invalid' : '' }}" value="{{ old('color_hair', $blacklist->color_hair) }}" name="color_hair" id="input-color_hair" type="text"  value="{{ old('color_hair') }}" />
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-8 col-md-9">
                          <div class="form-group{{ $errors->has('marital_status') ? ' has-danger' : '' }}">
                            <input class="form-control{{ $errors->has('marital_status') ? ' is-invalid' : '' }}" value="{{ old('marital_status', $blacklist->marital_status) }}" name="marital_status" id="input-marital_status" type="text"  value="{{ old('marital_status') }}" />
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-8 col-md-9">
                          <div class="form-group{{ $errors->has('city_residence') ? ' has-danger' : '' }}">
                            <input class="form-control{{ $errors->has('city_residence') ? ' is-invalid' : '' }}" value="{{ old('city_residence', $blacklist->city_residence) }}" name="city_residence" id="input-city_residence" type="text" value="{{ old('city_residence') }}" />
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-8 col-md-9">
                          <div class="form-group{{ $errors->has('postal_address') ? ' has-danger' : '' }}">
                            <input class="form-control{{ $errors->has('postal_address') ? ' is-invalid' : '' }}" value="{{ old('postal_address', $blacklist->postal_address) }}" name="postal_address" id="input-postal_address" type="text" value="{{ old('postal_address') }}" />
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-8 col-md-9">
                          <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                            <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" value="{{ old('email', $blacklist->email) }}" name="email" id="input-email" type="email" value="{{ old('email') }}"/>
                            @if ($errors->has('email'))
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-8 col-md-9">
                          <div class="form-group{{ $errors->has('phone_no') ? ' has-danger' : '' }}">
                            <input class="form-control{{ $errors->has('phone_no') ? ' is-invalid' : '' }}" value="{{ old('phone_no', $blacklist->phone_no) }}" name="phone_no" id="input-phone_no" type="text"  value="{{ old('phone_no') }}" />
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-8 col-md-9">
                          <div class="form-group{{ $errors->has('accomplice') ? ' has-danger' : '' }}">
                            <input class="form-control{{ $errors->has('accomplice') ? ' is-invalid' : '' }}" value="{{ old('accomplice', $blacklist->accomplice) }}" name="accomplice" id="input-accomplice" type="text"  value="{{ old('accomplice') }}" />
